...
```javascript
iterMap2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map2@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-tools-map2@v0.2.0-umd/browser.js"></script>
```
